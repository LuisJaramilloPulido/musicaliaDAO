...
public class DAOClienteImp implements DAOCliente {
    ...
    public TransferCliente consultarClienteDAO(String dni) {
        ...
        //String sql = "SELECT id_cliente, nombre, apellido, dni, direccion, socio FROM Clientes WHERE dni=? AND activo=1";
        String sql = "SELECT id_cliente, nombre, apellido, dni, direccion, socio FROM Clientes WHERE dni=? AND activo=1";
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
    ...
    public TransferCliente consultarClienteDAO(Integer id) {
        ...
        String sql = "Select id_cliente, nombre, apellido, dni, direccion, socio FROM Clientes WHERE id_cliente=? AND activo=1";
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            pstmt.setInt(1, id);
	...
	public List<TransferCliente> listarClientesDAO() {
        ...
        String sql = "Select id_cliente, nombre, apellido, dni, direccion, socio FROM Clientes WHERE activo=1";
